"""Tests that CRUD replica remotes."""
...
from pulp_replica.tests.functional.constants import DOWNLOAD_POLICIES
...
from pulpcore.client.pulp_replica import RemotesReplicaApi
...
class CRUDRemotesTestCase(unittest.TestCase):
    ...
    def setUpClass(cls):
        ...
        cls.remote_api = RemotesReplicaApi(gen_replica_client())
...
class CreateRemoteNoURLTestCase(unittest.TestCase):
    ...
    def test_all(self):
        ...
        * `Pulp Smash #984 <https://github.com/pulp/pulp-smash/issues/984>`_
        ...
        del body["url"]
        with self.assertRaises(ApiException):
            RemotesReplicaApi(gen_replica_client()).create(body)
